...
API_ID = int(environ.get('API_ID', '27912388'))
API_HASH = environ.get('API_HASH', 'dfd16b787e38a3f9bb26aee737034937')
BOT_TOKEN = environ.get('BOT_TOKEN', '7744652018:AAHieM4MDMyVYXFrhZidVD0CmjLGY8UOAyE')
#---------------------------------------------------------------
#---------------------------------------------------------------
...
#---------------------------------------------------------------
#---------------------------------------------------------------
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://AMAR:AMAR@amar.oo9hx.mongodb.net/?retryWrites=true&w=majority&appName=AMAR")
DATABASE_NAME = environ.get('DATABASE_NAME', "AMAR")
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/discussionfilm0') #Support group link ( make sure bot is admin )
#---------------------------------------------------------------
#---------------------------------------------------------------
...
#---------------------------------------------------------------
#---------------------------------------------------------------
START_IMG = (environ.get('START_IMG', 'https://graph.org/file/f47c5cd91f820d7233ea4-530489499875cd1179.jpg')).split()
