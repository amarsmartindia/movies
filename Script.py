import os
class script(object):
    START_TXT = """<b>ʜᴇʏ {}, {}\n\nɪ Welcome to our powerfull bot Amar Smart India  Here you can get your movie that you want just sseach.😍\n<blockquote>🌿 ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : <a href="@amarsmartindia_movieproviderbot">Jɪssʜᴜ Bᴏᴛs</a></blockquote></b>"""
...
<blockquote>🌿 ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : <a href='https://t.me/Hakindon0'>Amar</a></b></blockquote>"""
    

    ABOUT_TEXT = """<blockquote><b>‣ ᴍʏ ɴᴀᴍᴇ :AMAR KUMAR\n‣ ᴄʀᴇᴀᴛᴏʀ : <a href='https://t.me/amarsmartindia>AMAR KUMAR</a>\n‣ ʟɪʙʀᴀʀʏ : ᴘʏʀᴏɢʀᴀᴍ\n‣ ʟᴀɴɢᴜᴀɢᴇ : ᴘʏᴛʜᴏɴ\n‣ ᴅᴀᴛᴀ ʙᴀsᴇ : ᴍᴏɴɢᴏ ᴅʙ\n‣ ʜᴏsᴛᴇᴅ ᴏɴ  : ᴀʟʟ ᴡᴇʙ\n‣ ʙᴜɪʟᴅ sᴛᴀᴛᴜs : ᴠ5.2 [sᴛᴀʙʟᴇ]</b></blockquote>"""    
...
"""
    ...
    FILE_CAPTION = """<b>{file_name}\n\n𝖩𝗈𝗂𝗇➥ 「<a href="https://t.me/+PZLmy1dinyA1MWQ9">AMAR KUMAR </a>」</b>"""
    ...
    NO_RESULT_TXT = """<b>THIS IS MAYBE NOT RELEASE OR NOT UPLOADED IN MY DATABASE🙄</b>"""
...
<blockquote>🎖️ᴀᴠᴀɪʟᴀʙʟᴇ FREEMIUM ᴘʟᴀɴꜱ :</blockquote>

 <code>××××</code> [ᴛᴀᴘ ᴛᴏ ᴄᴏᴘʏ]
 
⛽️ ᴄʜᴇᴄᴋ ʏᴏᴜʀ ᴀᴄᴛɪᴠᴇ ᴘʟᴀɴ: /myplan

🏷️ <a href='https://t.me/amarsmartindia'>ᴘʀᴇᴍɪᴜᴍ ᴘʀᴏᴏꜰCOSTFREEMIUM</b>"""
...
--------------Set Ads----------------
➩ /set_ads {ads name}}#{Times}#{photo URL} - <a href="https://t.me/disscusionfilm0/11">Explain</a>
➩ /del_ads - Delete ads
-------------Top Trending------------
➩ /setlist {PUSPA 2, Money Heist} - <a href=https://t.me/discussionfilm0/10>Explain</a>
...
--------------Verify On Off------------
/verifyoff {{verify.off code}} - off verification <a href="https://t.me/discussionfilm0">Cᴏɴᴛᴀᴄᴛ</a> ᴛʜᴇ ʙᴏᴛ ᴀᴅᴍɪɴ ғᴏʀ ᴀ ᴠᴇʀɪғʏ.ᴏғғ ᴄᴏᴅᴇ
...
Aᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴀɴᴅ ᴍᴀᴋᴇ ᴍᴇ ᴀᴅᴍɪɴ ᴀɴᴅ ᴜsᴇ ᴀʟʟ ғᴇᴀᴛᴜʀᴇs😇</b>"""
    ...
    SOURCE_TXT = """<b>
NOTE:
- Create Your Bot ◉› :<blockquote><a href="@amarsmartindia_movieproviderbot">Amar-Smart-India</a></blockquote>

developer - AMAR KUMAR 
</b>""" 
...
Iғ ʏᴏᴜ ʜᴀᴠᴇ ᴀɴʏ ᴅᴏᴜʙᴛs ᴘʟᴇᴀsᴇ <a href="t.me/amarsmartindia>ᴄᴏɴᴛᴀᴄᴛ</a> ᴍʏ <a href="https://t.me/hakingdon0">ᴀᴅᴍɪɴ</a></b>"""
